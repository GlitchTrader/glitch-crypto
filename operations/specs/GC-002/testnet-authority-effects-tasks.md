# Tasks: Dormant Testnet authority and effect composition

**Rail item**: `GC-002` | **Inputs**: `testnet-authority-effects-spec.md`, `testnet-authority-effects-plan.md`, ADR 0016

- [x] R001 Implement proof-derived operator-only permit issuance.
- [x] R002 Implement exact coordinator-to-orchestrator effect composition.
